...
#ifndef __MPIMESSAGE_HPP__
#define __MPIMESSAGE_HPP__

enum g_eMsg{ GETNAME, START, ADD, PLAY, CHECK, DISPROVE, SUGGESTION, ACCUSATION, VERIFYACCUSATION, END }; // MPI Message
